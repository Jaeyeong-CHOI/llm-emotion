...
DEFAULT_SCREENING_RULES = {
    ...
    "term_aliases": {
        ...
        "emotion": ["emotion", "emotions", "emotional", "affect", "affective", "sentiment understanding"],
        "emotion recognition": ["emotion recognition", "emotion detection", "affective recognition"],
        "anthropomorphism": ["anthropomorphism", "anthropomorphic"],
        "theory of mind": ["theory of mind", "mentalizing", "mental state", "perspective taking", "mindreading"],
        "mental state": ["mental state", "mental states", "mentalizing", "social inference", "intent inference"],
        "self-reflection": ["self-reflection", "self reflection", "reflective reasoning", "self-disclosure", "self narration"],
    },
    "weights": {
        "include_any": 1.0,
        "high_priority": 2.0,
