...
def main():
    ...
    ap.add_argument(
        ...
        type=float,
        default=0.0,
        help="fail if top-18 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
    ...
    ap.add_argument(
        ...
        type=float,
        default=0.0,
        help="fail if top-18 temperature share exceeds this multiple of uniform top-18 share baseline (0 disables)",
    )
    ap.add_argument(
