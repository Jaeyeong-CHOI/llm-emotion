...
def write_preflight_markdown(path: Path, payload: dict):
    ...
    lines = [
        ...
        f"- planned_sample_temperature_top4_share: `{summary.get('planned_sample_temperature_top4_share', 0.0)}`",
        f"- planned_sample_temperature_top5_share: `{summary.get('planned_sample_temperature_top5_share', 0.0)}`",
        f"- planned_sample_temperature_top6_share: `{summary.get('planned_sample_temperature_top6_share', 0.0)}`",
        f"- planned_sample_temperature_top7_share: `{summary.get('planned_sample_temperature_top7_share', 0.0)}`",
        f"- planned_sample_temperature_top8_share: `{summary.get('planned_sample_temperature_top8_share', 0.0)}`",
        f"- planned_sample_temperature_top9_share: `{summary.get('planned_sample_temperature_top9_share', 0.0)}`",
        f"- planned_sample_temperature_top10_share: `{summary.get('planned_sample_temperature_top10_share', 0.0)}`",
        f"- planned_sample_temperature_tail_share: `{summary.get('planned_sample_temperature_tail_share', 0.0)}`",
        f"- planned_sample_temperature_min_share: `{summary.get('planned_sample_temperature_min_share', 0.0)}`",
        f"- planned_sample_temperature_floor_bins: `{summary.get('planned_sample_temperature_floor_bins', 0)}`",
        f"- planned_sample_temperature_floor_bin_share_gap: `{summary.get('planned_sample_temperature_floor_bin_share_gap', 0.0)}`",
        f"- planned_sample_temperature_hhi: `{summary.get('planned_sample_temperature_hhi', 0.0)}`",
        ...
        f"- planned_sample_temperature_p99_over_p95_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p95_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p90_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p90_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p85_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p85_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p80_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p80_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p75_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p75_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p70_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p70_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p65_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p65_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p60_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p60_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p55_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p55_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p50_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p50_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p45_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p45_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p40_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p40_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p35_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p35_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p30_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p30_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p25_share_ratio: `{summary.get('planned_sample_temperature_p99_over_p25_share_ratio', 0.0)}`",
...
def write_manifest_markdown(path: Path, manifest: dict):
    ...
    lines = [
        ...
        f"- planned_sample_temperature_top5_share: `{preflight_summary.get('planned_sample_temperature_top5_share', 0.0)}`",
        f"- planned_sample_temperature_top6_share: `{preflight_summary.get('planned_sample_temperature_top6_share', 0.0)}`",
        f"- planned_sample_temperature_top10_share: `{preflight_summary.get('planned_sample_temperature_top10_share', 0.0)}`",
        f"- planned_sample_temperature_top11_share: `{preflight_summary.get('planned_sample_temperature_top11_share', 0.0)}`",
        f"- planned_sample_temperature_top12_share: `{preflight_summary.get('planned_sample_temperature_top12_share', 0.0)}`",
        f"- planned_sample_temperature_top13_share: `{preflight_summary.get('planned_sample_temperature_top13_share', 0.0)}`",
        f"- planned_sample_temperature_top14_share: `{preflight_summary.get('planned_sample_temperature_top14_share', 0.0)}`",
        f"- planned_sample_temperature_top15_share: `{preflight_summary.get('planned_sample_temperature_top15_share', 0.0)}`",
        f"- planned_sample_temperature_top16_share: `{preflight_summary.get('planned_sample_temperature_top16_share', 0.0)}`",
        f"- planned_sample_temperature_top17_share: `{preflight_summary.get('planned_sample_temperature_top17_share', 0.0)}`",
        f"- planned_sample_temperature_top18_share: `{preflight_summary.get('planned_sample_temperature_top18_share', 0.0)}`",
        f"- planned_sample_temperature_top19_share: `{preflight_summary.get('planned_sample_temperature_top19_share', 0.0)}`",
        f"- planned_sample_temperature_tail_share: `{preflight_summary.get('planned_sample_temperature_tail_share', 0.0)}`",
        f"- planned_sample_temperature_min_share: `{preflight_summary.get('planned_sample_temperature_min_share', 0.0)}`",
        f"- planned_sample_temperature_floor_bins: `{preflight_summary.get('planned_sample_temperature_floor_bins', 0)}`",
        f"- planned_sample_temperature_floor_bin_share_gap: `{preflight_summary.get('planned_sample_temperature_floor_bin_share_gap', 0.0)}`",
        ...
        f"- planned_sample_temperature_top5_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top5_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top6_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top6_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top7_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top7_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top8_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top8_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top9_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top9_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top10_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top10_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top11_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top11_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top12_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top12_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top13_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top13_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top14_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top14_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top15_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top15_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top16_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top16_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top17_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top17_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top18_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top18_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top19_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top19_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top20_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top20_over_uniform_ratio', 0.0)}`",
        f"- planned_sample_temperature_top21_over_uniform_ratio: `{preflight_summary.get('planned_sample_temperature_top21_over_uniform_ratio', 0.0)}`",
        ...
        f"- planned_sample_temperature_p99_over_p95_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p95_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p90_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p90_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p85_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p85_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p80_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p80_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p75_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p75_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p70_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p70_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p65_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p65_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p60_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p60_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p55_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p55_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p50_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p50_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p45_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p45_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p40_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p40_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p35_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p35_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p30_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p30_share_ratio', 0.0)}`",
        f"- planned_sample_temperature_p99_over_p25_share_ratio: `{preflight_summary.get('planned_sample_temperature_p99_over_p25_share_ratio', 0.0)}`",
...
def main():
    ...
    ap.add_argument(
        "--max-planned-sample-temperature-top4-share",
        type=float,
        default=0.0,
        help="fail if top-4 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top5-share",
        type=float,
        default=0.0,
        help="fail if top-5 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top6-share",
        type=float,
        default=0.0,
        help="fail if top-6 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top7-share",
        type=float,
        default=0.0,
        help="fail if top-7 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top8-share",
        type=float,
        default=0.0,
        help="fail if top-8 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top9-share",
        type=float,
        default=0.0,
        help="fail if top-9 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top10-share",
        type=float,
        default=0.0,
        help="fail if top-10 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top11-share",
        type=float,
        default=0.0,
        help="fail if top-11 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top12-share",
        type=float,
        default=0.0,
        help="fail if top-12 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top13-share",
        type=float,
        default=0.0,
        help="fail if top-13 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top14-share",
        type=float,
        default=0.0,
        help="fail if top-14 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top15-share",
        type=float,
        default=0.0,
        help="fail if top-15 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top16-share",
        type=float,
        default=0.0,
        help="fail if top-16 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top17-share",
        type=float,
        default=0.0,
        help="fail if top-17 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top18-share",
        type=float,
        default=0.0,
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top19-share",
        type=float,
        default=0.0,
        help="fail if top-19 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top20-share",
        type=float,
        default=0.0,
        help="fail if top-20 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top21-share",
        type=float,
        default=0.0,
        help="fail if top-21 temperatures account for more than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--min-planned-sample-temperature-tail-share",
        type=float,
        default=0.0,
        help="fail if temperatures outside the top-2 account for less than this planned-sample share (0 disables)",
    )
    ap.add_argument(
        "--min-planned-sample-temperature-min-share",
        type=float,
        default=0.0,
        help="fail if the least-covered temperature share in the planned batch falls below this floor (0 disables)",
    )
    ap.add_argument(
        "--planned-sample-temperature-floor-share",
        type=float,
        default=0.0,
        help="temperature share floor used with --min-planned-sample-temperature-floor-bins (0 disables)",
    )
    ap.add_argument(
        "--min-planned-sample-temperature-floor-bins",
        type=int,
        default=0,
        help="fail if fewer than this many temperature bins meet --planned-sample-temperature-floor-share (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-floor-bin-share-gap",
        type=float,
        default=0.0,
        help="fail if max-min share gap across floor-qualified temperature bins exceeds this value (0 disables)",
    )
    ap.add_argument(
    ...
    ap.add_argument(
        "--max-planned-sample-temperature-top4-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-4 temperature share exceeds this multiple of uniform top-4 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top5-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-5 temperature share exceeds this multiple of uniform top-5 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top6-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-6 temperature share exceeds this multiple of uniform top-6 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top7-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-7 temperature share exceeds this multiple of uniform top-7 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top8-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-8 temperature share exceeds this multiple of uniform top-8 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top9-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-9 temperature share exceeds this multiple of uniform top-9 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top10-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-10 temperature share exceeds this multiple of uniform top-10 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top11-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-11 temperature share exceeds this multiple of uniform top-11 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top12-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-12 temperature share exceeds this multiple of uniform top-12 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top13-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-13 temperature share exceeds this multiple of uniform top-13 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top14-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-14 temperature share exceeds this multiple of uniform top-14 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top15-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-15 temperature share exceeds this multiple of uniform top-15 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top16-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-16 temperature share exceeds this multiple of uniform top-16 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top17-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-17 temperature share exceeds this multiple of uniform top-17 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top18-over-uniform-ratio",
        type=float,
        default=0.0,
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top19-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-19 temperature share exceeds this multiple of uniform top-19 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top20-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-20 temperature share exceeds this multiple of uniform top-20 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-top21-over-uniform-ratio",
        type=float,
        default=0.0,
        help="fail if top-21 temperature share exceeds this multiple of uniform top-21 share baseline (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-hhi",
        type=float,
        default=0.0,
        help="fail if planned-sample temperature Herfindahl-Hirschman index exceeds this value (0 disables)",
    )
    ap.add_argument(
    ...
    ap.add_argument(
        "--max-planned-sample-temperature-gini",
        type=float,
        default=0.0,
        help="fail if planned-sample temperature Gini concentration exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p90-over-median-share-ratio",
        type=float,
        default=0.0,
        help="fail if p90 temperature share / median temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p95-over-median-share-ratio",
        type=float,
        default=0.0,
    ...
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p95-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p95 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p90-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p90 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p85-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p85 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p80-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p80 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p75-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p75 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p70-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p70 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p65-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p65 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p60-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p60 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p55-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p55 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p50-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p50 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p45-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p45 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p40-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p40 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p35-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p35 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p30-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p30 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
        "--max-planned-sample-temperature-p99-over-p25-share-ratio",
        type=float,
        default=0.0,
        help="fail if p99 temperature share / p25 temperature share exceeds this value (0 disables)",
    )
    ap.add_argument(
    ...
    ap.add_argument(
        "--max-generation-timeout-failure-share-per-run-id",
        type=float,
        default=0.0,
        help="fail if a run id owns more than this share of generation timeout failures; 0 disables",
    )
    ap.add_argument(
    ...
    ap.add_argument(
        "--max-analysis-timeout-failure-share-per-run-id",
        type=float,
        default=0.0,
        help="fail if a run id owns more than this share of analysis timeout failures; 0 disables",
    )
    ap.add_argument(
        "--quarantine-json",
        default="",
    ...
    planned_sample_temperature_top4_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:4]),
        4,
    )
    planned_sample_temperature_top5_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:5]),
        4,
    )
    planned_sample_temperature_top6_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:6]),
        4,
    )
    planned_sample_temperature_top7_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:7]),
        4,
    )
    planned_sample_temperature_top8_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:8]),
        4,
    )
    planned_sample_temperature_top9_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:9]),
        4,
    )
    planned_sample_temperature_top10_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:10]),
        4,
    )
    planned_sample_temperature_top11_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:11]),
        4,
    )
    planned_sample_temperature_top12_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:12]),
        4,
    )
    planned_sample_temperature_top13_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:13]),
        4,
    )
    planned_sample_temperature_top14_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:14]),
        4,
    )
    planned_sample_temperature_top15_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:15]),
        4,
    )
    planned_sample_temperature_top16_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:16]),
        4,
    )
    planned_sample_temperature_top17_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:17]),
        4,
    )
    planned_sample_temperature_top18_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:18]),
        4,
    )
    planned_sample_temperature_top19_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:19]),
        4,
    )
    planned_sample_temperature_top20_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:20]),
        4,
    )
    planned_sample_temperature_top21_share = round(
        sum(sorted(planned_sample_temperature_shares.values(), reverse=True)[:21]),
        4,
    )
    planned_sample_temperature_tail_share = round(
        max(0.0, 1.0 - planned_sample_temperature_top2_share),
        4,
    )
    planned_sample_temperature_min_share = round(
        min(planned_sample_temperature_shares.values()),
        4,
    ) if planned_sample_temperature_shares else 0.0
    floor_qualified_temperature_shares = [
        float(share)
        for share in planned_sample_temperature_shares.values()
        if share >= args.planned_sample_temperature_floor_share
    ]
    planned_sample_temperature_floor_bins = len(floor_qualified_temperature_shares)
    planned_sample_temperature_floor_bin_share_gap = (
        round(max(floor_qualified_temperature_shares) - min(floor_qualified_temperature_shares), 4)
        if len(floor_qualified_temperature_shares) > 1
        else 0.0
    )
    planned_sample_temperature_hhi = round(
        sum((float(share) ** 2) for share in planned_sample_temperature_shares.values()),
        6,
    )
    ...
    sorted_temperature_shares = sorted(float(v) for v in planned_sample_temperature_shares.values())
    planned_sample_temperature_gini = 0.0
    if sorted_temperature_shares:
        n_shares = len(sorted_temperature_shares)
        share_sum = sum(sorted_temperature_shares)
        if n_shares > 1 and share_sum > 0:
            weighted_sum = sum((idx + 1) * share for idx, share in enumerate(sorted_temperature_shares))
    ...
    planned_sample_temperature_p99_over_p95_share_ratio = 0.0
    planned_sample_temperature_p99_over_p90_share_ratio = 0.0
    planned_sample_temperature_p99_over_p85_share_ratio = 0.0
    planned_sample_temperature_p99_over_p80_share_ratio = 0.0
    planned_sample_temperature_p99_over_p75_share_ratio = 0.0
    planned_sample_temperature_p99_over_p70_share_ratio = 0.0
    planned_sample_temperature_p99_over_p65_share_ratio = 0.0
    planned_sample_temperature_p99_over_p60_share_ratio = 0.0
    planned_sample_temperature_p99_over_p55_share_ratio = 0.0
    planned_sample_temperature_p99_over_p50_share_ratio = 0.0
    planned_sample_temperature_p99_over_p45_share_ratio = 0.0
    planned_sample_temperature_p99_over_p40_share_ratio = 0.0
    planned_sample_temperature_p99_over_p35_share_ratio = 0.0
    planned_sample_temperature_p99_over_p30_share_ratio = 0.0
    planned_sample_temperature_p99_over_p25_share_ratio = 0.0
    if sorted_temperature_shares:
        ...
        p85_idx = max(0, math.ceil(0.85 * len(sorted_temperature_shares)) - 1)
        p80_idx = max(0, math.ceil(0.8 * len(sorted_temperature_shares)) - 1)
        p75_idx = max(0, math.ceil(0.75 * len(sorted_temperature_shares)) - 1)
        p70_idx = max(0, math.ceil(0.7 * len(sorted_temperature_shares)) - 1)
        p65_idx = max(0, math.ceil(0.65 * len(sorted_temperature_shares)) - 1)
        p60_idx = max(0, math.ceil(0.60 * len(sorted_temperature_shares)) - 1)
        p90_share = sorted_temperature_shares[p90_idx]
        p85_share = sorted_temperature_shares[p85_idx]
        p80_share = sorted_temperature_shares[p80_idx]
        p75_share = sorted_temperature_shares[p75_idx]
        p70_share = sorted_temperature_shares[p70_idx]
        p65_share = sorted_temperature_shares[p65_idx]
        p60_share = sorted_temperature_shares[p60_idx]
        p55_idx = max(0, math.ceil(0.55 * len(sorted_temperature_shares)) - 1)
        p55_share = sorted_temperature_shares[p55_idx]
        p50_idx = max(0, math.ceil(0.50 * len(sorted_temperature_shares)) - 1)
        p50_share = sorted_temperature_shares[p50_idx]
        p45_idx = max(0, math.ceil(0.45 * len(sorted_temperature_shares)) - 1)
        p45_share = sorted_temperature_shares[p45_idx]
        p40_idx = max(0, math.ceil(0.40 * len(sorted_temperature_shares)) - 1)
        p40_share = sorted_temperature_shares[p40_idx]
        p35_idx = max(0, math.ceil(0.35 * len(sorted_temperature_shares)) - 1)
        p35_share = sorted_temperature_shares[p35_idx]
        p30_idx = max(0, math.ceil(0.30 * len(sorted_temperature_shares)) - 1)
        p30_share = sorted_temperature_shares[p30_idx]
        p25_idx = max(0, math.ceil(0.25 * len(sorted_temperature_shares)) - 1)
        p25_share = sorted_temperature_shares[p25_idx]
        planned_sample_temperature_p90_over_median_share_ratio = round(p90_share / max(1e-9, median_share), 4)
        ...
        planned_sample_temperature_p99_over_p95_share_ratio = round(p99_share / max(1e-9, p95_share), 4)
        planned_sample_temperature_p99_over_p90_share_ratio = round(p99_share / max(1e-9, p90_share), 4)
        planned_sample_temperature_p99_over_p85_share_ratio = round(p99_share / max(1e-9, p85_share), 4)
        planned_sample_temperature_p99_over_p80_share_ratio = round(p99_share / max(1e-9, p80_share), 4)
        planned_sample_temperature_p99_over_p75_share_ratio = round(p99_share / max(1e-9, p75_share), 4)
        planned_sample_temperature_p99_over_p70_share_ratio = round(p99_share / max(1e-9, p70_share), 4)
        planned_sample_temperature_p99_over_p65_share_ratio = round(p99_share / max(1e-9, p65_share), 4)
        planned_sample_temperature_p99_over_p60_share_ratio = round(p99_share / max(1e-9, p60_share), 4)
        planned_sample_temperature_p99_over_p55_share_ratio = round(p99_share / max(1e-9, p55_share), 4)
        planned_sample_temperature_p99_over_p50_share_ratio = round(p99_share / max(1e-9, p50_share), 4)
        planned_sample_temperature_p99_over_p45_share_ratio = round(p99_share / max(1e-9, p45_share), 4)
        planned_sample_temperature_p99_over_p40_share_ratio = round(p99_share / max(1e-9, p40_share), 4)
        planned_sample_temperature_p99_over_p35_share_ratio = round(p99_share / max(1e-9, p35_share), 4)
        planned_sample_temperature_p99_over_p30_share_ratio = round(p99_share / max(1e-9, p30_share), 4)
        planned_sample_temperature_p99_over_p25_share_ratio = round(p99_share / max(1e-9, p25_share), 4)
    ...
    uniform_temperature_top5_share = round(min(5, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top6_share = round(min(6, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top7_share = round(min(7, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top8_share = round(min(8, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top9_share = round(min(9, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top10_share = round(min(10, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top11_share = round(min(11, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top12_share = round(min(12, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top13_share = round(min(13, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top14_share = round(min(14, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top15_share = round(min(15, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top16_share = round(min(16, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top17_share = round(min(17, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top18_share = round(min(18, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top19_share = round(min(19, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top20_share = round(min(20, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    uniform_temperature_top21_share = round(min(21, len(planned_sample_temperature_shares)) * uniform_temperature_share, 4)
    ...
    planned_sample_temperature_top4_over_uniform_ratio = round(
        planned_sample_temperature_top4_share / max(1e-9, uniform_temperature_top4_share),
        4,
    )
    planned_sample_temperature_top5_over_uniform_ratio = round(
        planned_sample_temperature_top5_share / max(1e-9, uniform_temperature_top5_share),
        4,
    )
    planned_sample_temperature_top6_over_uniform_ratio = round(
        planned_sample_temperature_top6_share / max(1e-9, uniform_temperature_top6_share),
        4,
    )
    planned_sample_temperature_top7_over_uniform_ratio = round(
        planned_sample_temperature_top7_share / max(1e-9, uniform_temperature_top7_share),
        4,
    )
    planned_sample_temperature_top8_over_uniform_ratio = round(
        planned_sample_temperature_top8_share / max(1e-9, uniform_temperature_top8_share),
        4,
    )
    planned_sample_temperature_top9_over_uniform_ratio = round(
        planned_sample_temperature_top9_share / max(1e-9, uniform_temperature_top9_share),
        4,
    )
    planned_sample_temperature_top10_over_uniform_ratio = round(
        planned_sample_temperature_top10_share / max(1e-9, uniform_temperature_top10_share),
        4,
    )
    planned_sample_temperature_top11_over_uniform_ratio = round(
        planned_sample_temperature_top11_share / max(1e-9, uniform_temperature_top11_share),
        4,
    )
    planned_sample_temperature_top12_over_uniform_ratio = round(
        planned_sample_temperature_top12_share / max(1e-9, uniform_temperature_top12_share),
        4,
    )
    planned_sample_temperature_top13_over_uniform_ratio = round(
        planned_sample_temperature_top13_share / max(1e-9, uniform_temperature_top13_share),
        4,
    )
    planned_sample_temperature_top14_over_uniform_ratio = round(
        planned_sample_temperature_top14_share / max(1e-9, uniform_temperature_top14_share),
        4,
    )
    planned_sample_temperature_top15_over_uniform_ratio = round(
        planned_sample_temperature_top15_share / max(1e-9, uniform_temperature_top15_share),
        4,
    )
    planned_sample_temperature_top16_over_uniform_ratio = round(
        planned_sample_temperature_top16_share / max(1e-9, uniform_temperature_top16_share),
        4,
    )
    planned_sample_temperature_top17_over_uniform_ratio = round(
        planned_sample_temperature_top17_share / max(1e-9, uniform_temperature_top17_share),
        4,
    )
    planned_sample_temperature_top18_over_uniform_ratio = round(
        planned_sample_temperature_top18_share / max(1e-9, uniform_temperature_top18_share),
        4,
    )
    planned_sample_temperature_top19_over_uniform_ratio = round(
        planned_sample_temperature_top19_share / max(1e-9, uniform_temperature_top19_share),
        4,
    )
    planned_sample_temperature_top20_over_uniform_ratio = round(
        planned_sample_temperature_top20_share / max(1e-9, uniform_temperature_top20_share),
        4,
    )
    planned_sample_temperature_top21_over_uniform_ratio = round(
        planned_sample_temperature_top21_share / max(1e-9, uniform_temperature_top21_share),
        4,
    )
    ...
    if (
        args.max_planned_sample_temperature_top4_share
        and planned_sample_temperature_top4_share > args.max_planned_sample_temperature_top4_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top4_share="
            f"{planned_sample_temperature_top4_share} > max_planned_sample_temperature_top4_share={args.max_planned_sample_temperature_top4_share}"
        )
    if (
        args.max_planned_sample_temperature_top5_share
        and planned_sample_temperature_top5_share > args.max_planned_sample_temperature_top5_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top5_share="
            f"{planned_sample_temperature_top5_share} > max_planned_sample_temperature_top5_share={args.max_planned_sample_temperature_top5_share}"
        )
    if (
        args.max_planned_sample_temperature_top6_share
        and planned_sample_temperature_top6_share > args.max_planned_sample_temperature_top6_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top6_share="
            f"{planned_sample_temperature_top6_share} > max_planned_sample_temperature_top6_share={args.max_planned_sample_temperature_top6_share}"
        )
    if (
        args.max_planned_sample_temperature_top7_share
        and planned_sample_temperature_top7_share > args.max_planned_sample_temperature_top7_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top7_share="
            f"{planned_sample_temperature_top7_share} > max_planned_sample_temperature_top7_share={args.max_planned_sample_temperature_top7_share}"
        )
    if (
    ...
    if (
        args.max_planned_sample_temperature_top10_share
        and planned_sample_temperature_top10_share > args.max_planned_sample_temperature_top10_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top10_share="
            f"{planned_sample_temperature_top10_share} > max_planned_sample_temperature_top10_share={args.max_planned_sample_temperature_top10_share}"
        )
    if (
        args.max_planned_sample_temperature_top11_share
        and planned_sample_temperature_top11_share > args.max_planned_sample_temperature_top11_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top11_share="
            f"{planned_sample_temperature_top11_share} > max_planned_sample_temperature_top11_share={args.max_planned_sample_temperature_top11_share}"
        )
    if (
        args.max_planned_sample_temperature_top12_share
        and planned_sample_temperature_top12_share > args.max_planned_sample_temperature_top12_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top12_share="
            f"{planned_sample_temperature_top12_share} > max_planned_sample_temperature_top12_share={args.max_planned_sample_temperature_top12_share}"
        )
    if (
        args.max_planned_sample_temperature_top13_share
        and planned_sample_temperature_top13_share > args.max_planned_sample_temperature_top13_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top13_share="
            f"{planned_sample_temperature_top13_share} > max_planned_sample_temperature_top13_share={args.max_planned_sample_temperature_top13_share}"
        )
    if (
        args.max_planned_sample_temperature_top14_share
        and planned_sample_temperature_top14_share > args.max_planned_sample_temperature_top14_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top14_share="
            f"{planned_sample_temperature_top14_share} > max_planned_sample_temperature_top14_share={args.max_planned_sample_temperature_top14_share}"
        )
    if (
        args.max_planned_sample_temperature_top15_share
        and planned_sample_temperature_top15_share > args.max_planned_sample_temperature_top15_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top15_share="
            f"{planned_sample_temperature_top15_share} > max_planned_sample_temperature_top15_share={args.max_planned_sample_temperature_top15_share}"
        )
    if (
        args.max_planned_sample_temperature_top16_share
        and planned_sample_temperature_top16_share > args.max_planned_sample_temperature_top16_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top16_share="
            f"{planned_sample_temperature_top16_share} > max_planned_sample_temperature_top16_share={args.max_planned_sample_temperature_top16_share}"
        )
    if (
        args.max_planned_sample_temperature_top17_share
        and planned_sample_temperature_top17_share > args.max_planned_sample_temperature_top17_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top17_share="
            f"{planned_sample_temperature_top17_share} > max_planned_sample_temperature_top17_share={args.max_planned_sample_temperature_top17_share}"
        )
    if (
        args.max_planned_sample_temperature_top18_share
        and planned_sample_temperature_top18_share > args.max_planned_sample_temperature_top18_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top18_share="
            f"{planned_sample_temperature_top18_share} > max_planned_sample_temperature_top18_share={args.max_planned_sample_temperature_top18_share}"
        )
    if (
        args.max_planned_sample_temperature_top19_share
        and planned_sample_temperature_top19_share > args.max_planned_sample_temperature_top19_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top19_share="
            f"{planned_sample_temperature_top19_share} > max_planned_sample_temperature_top19_share={args.max_planned_sample_temperature_top19_share}"
        )
    if (
        args.max_planned_sample_temperature_top20_share
        and planned_sample_temperature_top20_share > args.max_planned_sample_temperature_top20_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top20_share="
            f"{planned_sample_temperature_top20_share} > max_planned_sample_temperature_top20_share={args.max_planned_sample_temperature_top20_share}"
        )
    if (
        args.max_planned_sample_temperature_top21_share
        and planned_sample_temperature_top21_share > args.max_planned_sample_temperature_top21_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_top21_share="
            f"{planned_sample_temperature_top21_share} > max_planned_sample_temperature_top21_share={args.max_planned_sample_temperature_top21_share}"
        )
    if (
        args.min_planned_sample_temperature_tail_share
        and planned_sample_temperature_tail_share < args.min_planned_sample_temperature_tail_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_tail_share="
            f"{planned_sample_temperature_tail_share} < min_planned_sample_temperature_tail_share={args.min_planned_sample_temperature_tail_share}"
        )
    if (
        args.min_planned_sample_temperature_min_share
        and planned_sample_temperature_min_share < args.min_planned_sample_temperature_min_share
    ):
        raise RuntimeError(
            "planned_sample_temperature_min_share="
            f"{planned_sample_temperature_min_share} < min_planned_sample_temperature_min_share={args.min_planned_sample_temperature_min_share}"
        )
    if args.min_planned_sample_temperature_floor_bins:
        if args.planned_sample_temperature_floor_share <= 0.0:
            raise RuntimeError(
                "planned_sample_temperature_floor_share must be > 0 when "
                "min_planned_sample_temperature_floor_bins is set"
            )
        if planned_sample_temperature_floor_bins < args.min_planned_sample_temperature_floor_bins:
            raise RuntimeError(
                "planned_sample_temperature_floor_bins="
                f"{planned_sample_temperature_floor_bins} < min_planned_sample_temperature_floor_bins={args.min_planned_sample_temperature_floor_bins} "
                f"(floor_share={args.planned_sample_temperature_floor_share})"
            )
    if (
        args.max_planned_sample_temperature_floor_bin_share_gap
        and planned_sample_temperature_floor_bin_share_gap > args.max_planned_sample_temperature_floor_bin_share_gap
    ):
        raise RuntimeError(
            "planned_sample_temperature_floor_bin_share_gap="
            f"{planned_sample_temperature_floor_bin_share_gap} > max_planned_sample_temperature_floor_bin_share_gap={args.max_planned_sample_temperature_floor_bin_share_gap}"
        )
    if (
        args.max_planned_sample_temperature_top4_over_uniform_ratio
        and planned_sample_temperature_top4_over_uniform_ratio > args.max_planned_sample_temperature_top4_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top4_over_uniform_ratio="
            f"{planned_sample_temperature_top4_over_uniform_ratio} > max_planned_sample_temperature_top4_over_uniform_ratio={args.max_planned_sample_temperature_top4_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top5_over_uniform_ratio
        and planned_sample_temperature_top5_over_uniform_ratio > args.max_planned_sample_temperature_top5_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top5_over_uniform_ratio="
            f"{planned_sample_temperature_top5_over_uniform_ratio} > max_planned_sample_temperature_top5_over_uniform_ratio={args.max_planned_sample_temperature_top5_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top6_over_uniform_ratio
        and planned_sample_temperature_top6_over_uniform_ratio > args.max_planned_sample_temperature_top6_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top6_over_uniform_ratio="
            f"{planned_sample_temperature_top6_over_uniform_ratio} > max_planned_sample_temperature_top6_over_uniform_ratio={args.max_planned_sample_temperature_top6_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top7_over_uniform_ratio
        and planned_sample_temperature_top7_over_uniform_ratio > args.max_planned_sample_temperature_top7_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top7_over_uniform_ratio="
            f"{planned_sample_temperature_top7_over_uniform_ratio} > max_planned_sample_temperature_top7_over_uniform_ratio={args.max_planned_sample_temperature_top7_over_uniform_ratio}"
        )
    if (
    ...
    if (
        args.max_planned_sample_temperature_top10_over_uniform_ratio
        and planned_sample_temperature_top10_over_uniform_ratio > args.max_planned_sample_temperature_top10_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top10_over_uniform_ratio="
            f"{planned_sample_temperature_top10_over_uniform_ratio} > max_planned_sample_temperature_top10_over_uniform_ratio={args.max_planned_sample_temperature_top10_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top11_over_uniform_ratio
        and planned_sample_temperature_top11_over_uniform_ratio > args.max_planned_sample_temperature_top11_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top11_over_uniform_ratio="
            f"{planned_sample_temperature_top11_over_uniform_ratio} > max_planned_sample_temperature_top11_over_uniform_ratio={args.max_planned_sample_temperature_top11_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top12_over_uniform_ratio
        and planned_sample_temperature_top12_over_uniform_ratio > args.max_planned_sample_temperature_top12_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top12_over_uniform_ratio="
            f"{planned_sample_temperature_top12_over_uniform_ratio} > max_planned_sample_temperature_top12_over_uniform_ratio={args.max_planned_sample_temperature_top12_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top13_over_uniform_ratio
        and planned_sample_temperature_top13_over_uniform_ratio > args.max_planned_sample_temperature_top13_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top13_over_uniform_ratio="
            f"{planned_sample_temperature_top13_over_uniform_ratio} > max_planned_sample_temperature_top13_over_uniform_ratio={args.max_planned_sample_temperature_top13_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top14_over_uniform_ratio
        and planned_sample_temperature_top14_over_uniform_ratio > args.max_planned_sample_temperature_top14_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top14_over_uniform_ratio="
            f"{planned_sample_temperature_top14_over_uniform_ratio} > max_planned_sample_temperature_top14_over_uniform_ratio={args.max_planned_sample_temperature_top14_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top15_over_uniform_ratio
        and planned_sample_temperature_top15_over_uniform_ratio > args.max_planned_sample_temperature_top15_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top15_over_uniform_ratio="
            f"{planned_sample_temperature_top15_over_uniform_ratio} > max_planned_sample_temperature_top15_over_uniform_ratio={args.max_planned_sample_temperature_top15_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top16_over_uniform_ratio
        and planned_sample_temperature_top16_over_uniform_ratio > args.max_planned_sample_temperature_top16_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top16_over_uniform_ratio="
            f"{planned_sample_temperature_top16_over_uniform_ratio} > max_planned_sample_temperature_top16_over_uniform_ratio={args.max_planned_sample_temperature_top16_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top17_over_uniform_ratio
        and planned_sample_temperature_top17_over_uniform_ratio > args.max_planned_sample_temperature_top17_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top17_over_uniform_ratio="
            f"{planned_sample_temperature_top17_over_uniform_ratio} > max_planned_sample_temperature_top17_over_uniform_ratio={args.max_planned_sample_temperature_top17_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top18_over_uniform_ratio
        and planned_sample_temperature_top18_over_uniform_ratio > args.max_planned_sample_temperature_top18_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top18_over_uniform_ratio="
            f"{planned_sample_temperature_top18_over_uniform_ratio} > max_planned_sample_temperature_top18_over_uniform_ratio={args.max_planned_sample_temperature_top18_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top19_over_uniform_ratio
        and planned_sample_temperature_top19_over_uniform_ratio > args.max_planned_sample_temperature_top19_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top19_over_uniform_ratio="
            f"{planned_sample_temperature_top19_over_uniform_ratio} > max_planned_sample_temperature_top19_over_uniform_ratio={args.max_planned_sample_temperature_top19_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top20_over_uniform_ratio
        and planned_sample_temperature_top20_over_uniform_ratio > args.max_planned_sample_temperature_top20_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top20_over_uniform_ratio="
            f"{planned_sample_temperature_top20_over_uniform_ratio} > max_planned_sample_temperature_top20_over_uniform_ratio={args.max_planned_sample_temperature_top20_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_top21_over_uniform_ratio
        and planned_sample_temperature_top21_over_uniform_ratio > args.max_planned_sample_temperature_top21_over_uniform_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_top21_over_uniform_ratio="
            f"{planned_sample_temperature_top21_over_uniform_ratio} > max_planned_sample_temperature_top21_over_uniform_ratio={args.max_planned_sample_temperature_top21_over_uniform_ratio}"
        )
    if (
        args.max_planned_sample_temperature_hhi
        and planned_sample_temperature_hhi > args.max_planned_sample_temperature_hhi
    ):
        raise RuntimeError(
            "planned_sample_temperature_hhi="
            f"{planned_sample_temperature_hhi} > max_planned_sample_temperature_hhi={args.max_planned_sample_temperature_hhi}"
        )
    if (
    ...
    if (
        args.max_planned_sample_temperature_gini
        and planned_sample_temperature_gini > args.max_planned_sample_temperature_gini
    ):
        raise RuntimeError(
            "planned_sample_temperature_gini="
            f"{planned_sample_temperature_gini} > max_planned_sample_temperature_gini={args.max_planned_sample_temperature_gini}"
        )
    if (
        args.max_planned_sample_temperature_p90_over_median_share_ratio
        and planned_sample_temperature_p90_over_median_share_ratio > args.max_planned_sample_temperature_p90_over_median_share_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_p90_over_median_share_ratio="
            f"{planned_sample_temperature_p90_over_median_share_ratio} > max_planned_sample_temperature_p90_over_median_share_ratio={args.max_planned_sample_temperature_p90_over_median_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p95_over_median_share_ratio
        and planned_sample_temperature_p95_over_median_share_ratio > args.max_planned_sample_temperature_p95_over_median_share_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_p95_over_median_share_ratio="
    ...
    if (
        args.max_planned_sample_temperature_p99_over_p95_share_ratio
        and planned_sample_temperature_p99_over_p95_share_ratio > args.max_planned_sample_temperature_p99_over_p95_share_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_p99_over_p95_share_ratio="
            f"{planned_sample_temperature_p99_over_p95_share_ratio} > max_planned_sample_temperature_p99_over_p95_share_ratio={args.max_planned_sample_temperature_p99_over_p95_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p90_share_ratio
        and planned_sample_temperature_p99_over_p90_share_ratio > args.max_planned_sample_temperature_p99_over_p90_share_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_p99_over_p90_share_ratio="
            f"{planned_sample_temperature_p99_over_p90_share_ratio} > max_planned_sample_temperature_p99_over_p90_share_ratio={args.max_planned_sample_temperature_p99_over_p90_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p85_share_ratio
        and planned_sample_temperature_p99_over_p85_share_ratio > args.max_planned_sample_temperature_p99_over_p85_share_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_p99_over_p85_share_ratio="
            f"{planned_sample_temperature_p99_over_p85_share_ratio} > max_planned_sample_temperature_p99_over_p85_share_ratio={args.max_planned_sample_temperature_p99_over_p85_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p80_share_ratio
        and planned_sample_temperature_p99_over_p80_share_ratio > args.max_planned_sample_temperature_p99_over_p80_share_ratio
    ):
        raise RuntimeError(
            "planned_sample_temperature_p99_over_p80_share_ratio="
            f"{planned_sample_temperature_p99_over_p80_share_ratio} > max_planned_sample_temperature_p99_over_p80_share_ratio={args.max_planned_sample_temperature_p99_over_p80_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p75_share_ratio
        and planned_sample_temperature_p99_over_p75_share_ratio > args.max_planned_sample_temperature_p99_over_p75_share_ratio
    ):
        preflight_errors.append(
            "planned_sample_temperature_p99_over_p75_share_ratio="
            f"{planned_sample_temperature_p99_over_p75_share_ratio} > max_planned_sample_temperature_p99_over_p75_share_ratio={args.max_planned_sample_temperature_p99_over_p75_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p70_share_ratio
        and planned_sample_temperature_p99_over_p70_share_ratio > args.max_planned_sample_temperature_p99_over_p70_share_ratio
    ):
        preflight_errors.append(
            "planned_sample_temperature_p99_over_p70_share_ratio="
            f"{planned_sample_temperature_p99_over_p70_share_ratio} > max_planned_sample_temperature_p99_over_p70_share_ratio={args.max_planned_sample_temperature_p99_over_p70_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p65_share_ratio
        and planned_sample_temperature_p99_over_p65_share_ratio > args.max_planned_sample_temperature_p99_over_p65_share_ratio
    ):
        preflight_errors.append(
            "planned_sample_temperature_p99_over_p65_share_ratio="
            f"{planned_sample_temperature_p99_over_p65_share_ratio} > max_planned_sample_temperature_p99_over_p65_share_ratio={args.max_planned_sample_temperature_p99_over_p65_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p60_share_ratio
        and planned_sample_temperature_p99_over_p60_share_ratio > args.max_planned_sample_temperature_p99_over_p60_share_ratio
    ):
        preflight_errors.append(
            "planned_sample_temperature_p99_over_p60_share_ratio="
            f"{planned_sample_temperature_p99_over_p60_share_ratio} > max_planned_sample_temperature_p99_over_p60_share_ratio={args.max_planned_sample_temperature_p99_over_p60_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p55_share_ratio
        and planned_sample_temperature_p99_over_p55_share_ratio > args.max_planned_sample_temperature_p99_over_p55_share_ratio
    ):
        preflight_errors.append(
            "planned_sample_temperature_p99_over_p55_share_ratio="
            f"{planned_sample_temperature_p99_over_p55_share_ratio} > max_planned_sample_temperature_p99_over_p55_share_ratio={args.max_planned_sample_temperature_p99_over_p55_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p50_share_ratio
        and planned_sample_temperature_p99_over_p50_share_ratio > args.max_planned_sample_temperature_p99_over_p50_share_ratio
    ):
        preflight_errors.append(
            "planned_sample_temperature_p99_over_p50_share_ratio="
            f"{planned_sample_temperature_p99_over_p50_share_ratio} > max_planned_sample_temperature_p99_over_p50_share_ratio={args.max_planned_sample_temperature_p99_over_p50_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p45_share_ratio
        and planned_sample_temperature_p99_over_p45_share_ratio > args.max_planned_sample_temperature_p99_over_p45_share_ratio
    ):
        preflight_errors.append(
            "planned_sample_temperature_p99_over_p45_share_ratio="
            f"{planned_sample_temperature_p99_over_p45_share_ratio} > max_planned_sample_temperature_p99_over_p45_share_ratio={args.max_planned_sample_temperature_p99_over_p45_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p40_share_ratio
        and planned_sample_temperature_p99_over_p40_share_ratio > args.max_planned_sample_temperature_p99_over_p40_share_ratio
    ):
        preflight_errors.append(
            "planned_sample_temperature_p99_over_p40_share_ratio="
            f"{planned_sample_temperature_p99_over_p40_share_ratio} > max_planned_sample_temperature_p99_over_p40_share_ratio={args.max_planned_sample_temperature_p99_over_p40_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p35_share_ratio
        and planned_sample_temperature_p99_over_p35_share_ratio > args.max_planned_sample_temperature_p99_over_p35_share_ratio
    ):
        preflight_errors.append(
            "planned_sample_temperature_p99_over_p35_share_ratio="
            f"{planned_sample_temperature_p99_over_p35_share_ratio} > max_planned_sample_temperature_p99_over_p35_share_ratio={args.max_planned_sample_temperature_p99_over_p35_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p30_share_ratio
        and planned_sample_temperature_p99_over_p30_share_ratio > args.max_planned_sample_temperature_p99_over_p30_share_ratio
    ):
        preflight_errors.append(
            "planned_sample_temperature_p99_over_p30_share_ratio="
            f"{planned_sample_temperature_p99_over_p30_share_ratio} > max_planned_sample_temperature_p99_over_p30_share_ratio={args.max_planned_sample_temperature_p99_over_p30_share_ratio}"
        )
    if (
        args.max_planned_sample_temperature_p99_over_p25_share_ratio
        and planned_sample_temperature_p99_over_p25_share_ratio > args.max_planned_sample_temperature_p99_over_p25_share_ratio
    ):
        preflight_errors.append(
            "planned_sample_temperature_p99_over_p25_share_ratio="
            f"{planned_sample_temperature_p99_over_p25_share_ratio} > max_planned_sample_temperature_p99_over_p25_share_ratio={args.max_planned_sample_temperature_p99_over_p25_share_ratio}"
        )
    ...
    preflight_summary = {
        ...
        "planned_sample_temperature_top4_share": planned_sample_temperature_top4_share,
        "planned_sample_temperature_top5_share": planned_sample_temperature_top5_share,
        "planned_sample_temperature_top6_share": planned_sample_temperature_top6_share,
        "planned_sample_temperature_top7_share": planned_sample_temperature_top7_share,
        "planned_sample_temperature_top8_share": planned_sample_temperature_top8_share,
        "planned_sample_temperature_top9_share": planned_sample_temperature_top9_share,
        "planned_sample_temperature_top10_share": planned_sample_temperature_top10_share,
        "planned_sample_temperature_top11_share": planned_sample_temperature_top11_share,
        "planned_sample_temperature_top12_share": planned_sample_temperature_top12_share,
        "planned_sample_temperature_top13_share": planned_sample_temperature_top13_share,
        "planned_sample_temperature_top14_share": planned_sample_temperature_top14_share,
        "planned_sample_temperature_top15_share": planned_sample_temperature_top15_share,
        "planned_sample_temperature_top16_share": planned_sample_temperature_top16_share,
        "planned_sample_temperature_top17_share": planned_sample_temperature_top17_share,
        "planned_sample_temperature_top18_share": planned_sample_temperature_top18_share,
        "planned_sample_temperature_top19_share": planned_sample_temperature_top19_share,
        "planned_sample_temperature_top20_share": planned_sample_temperature_top20_share,
        "planned_sample_temperature_top21_share": planned_sample_temperature_top21_share,
        "planned_sample_temperature_tail_share": planned_sample_temperature_tail_share,
        "planned_sample_temperature_min_share": planned_sample_temperature_min_share,
        "planned_sample_temperature_floor_bins": planned_sample_temperature_floor_bins,
        "planned_sample_temperature_floor_bin_share_gap": planned_sample_temperature_floor_bin_share_gap,
        ...
        "planned_sample_temperature_p99_over_p95_share_ratio": planned_sample_temperature_p99_over_p95_share_ratio,
        "planned_sample_temperature_p99_over_p90_share_ratio": planned_sample_temperature_p99_over_p90_share_ratio,
        "planned_sample_temperature_p99_over_p85_share_ratio": planned_sample_temperature_p99_over_p85_share_ratio,
        "planned_sample_temperature_p99_over_p80_share_ratio": planned_sample_temperature_p99_over_p80_share_ratio,
        "planned_sample_temperature_p99_over_p75_share_ratio": planned_sample_temperature_p99_over_p75_share_ratio,
        "planned_sample_temperature_p99_over_p70_share_ratio": planned_sample_temperature_p99_over_p70_share_ratio,
        "planned_sample_temperature_p99_over_p65_share_ratio": planned_sample_temperature_p99_over_p65_share_ratio,
        "planned_sample_temperature_p99_over_p60_share_ratio": planned_sample_temperature_p99_over_p60_share_ratio,
        "planned_sample_temperature_p99_over_p55_share_ratio": planned_sample_temperature_p99_over_p55_share_ratio,
        "planned_sample_temperature_p99_over_p50_share_ratio": planned_sample_temperature_p99_over_p50_share_ratio,
        "planned_sample_temperature_p99_over_p45_share_ratio": planned_sample_temperature_p99_over_p45_share_ratio,
        "planned_sample_temperature_p99_over_p40_share_ratio": planned_sample_temperature_p99_over_p40_share_ratio,
        "planned_sample_temperature_p99_over_p35_share_ratio": planned_sample_temperature_p99_over_p35_share_ratio,
        "planned_sample_temperature_p99_over_p30_share_ratio": planned_sample_temperature_p99_over_p30_share_ratio,
        "planned_sample_temperature_p99_over_p25_share_ratio": planned_sample_temperature_p99_over_p25_share_ratio,
        ...
        "planned_sample_temperature_top5_over_uniform_ratio": planned_sample_temperature_top5_over_uniform_ratio,
        "planned_sample_temperature_top6_over_uniform_ratio": planned_sample_temperature_top6_over_uniform_ratio,
        "planned_sample_temperature_top7_over_uniform_ratio": planned_sample_temperature_top7_over_uniform_ratio,
        "planned_sample_temperature_top8_over_uniform_ratio": planned_sample_temperature_top8_over_uniform_ratio,
        "planned_sample_temperature_top9_over_uniform_ratio": planned_sample_temperature_top9_over_uniform_ratio,
        "planned_sample_temperature_top10_over_uniform_ratio": planned_sample_temperature_top10_over_uniform_ratio,
        "planned_sample_temperature_top11_over_uniform_ratio": planned_sample_temperature_top11_over_uniform_ratio,
        "planned_sample_temperature_top12_over_uniform_ratio": planned_sample_temperature_top12_over_uniform_ratio,
        "planned_sample_temperature_top13_over_uniform_ratio": planned_sample_temperature_top13_over_uniform_ratio,
        "planned_sample_temperature_top14_over_uniform_ratio": planned_sample_temperature_top14_over_uniform_ratio,
        "planned_sample_temperature_top15_over_uniform_ratio": planned_sample_temperature_top15_over_uniform_ratio,
        "planned_sample_temperature_top16_over_uniform_ratio": planned_sample_temperature_top16_over_uniform_ratio,
        "planned_sample_temperature_top17_over_uniform_ratio": planned_sample_temperature_top17_over_uniform_ratio,
        "planned_sample_temperature_top18_over_uniform_ratio": planned_sample_temperature_top18_over_uniform_ratio,
        "planned_sample_temperature_top19_over_uniform_ratio": planned_sample_temperature_top19_over_uniform_ratio,
        "planned_sample_temperature_top20_over_uniform_ratio": planned_sample_temperature_top20_over_uniform_ratio,
        "planned_sample_temperature_top21_over_uniform_ratio": planned_sample_temperature_top21_over_uniform_ratio,
    ...
    if args.max_generation_timeout_failure_share_per_run_id and generation_timeout_failures_total > 0:
        over_generation_timeout_share = [
            f"{run_id}:{round(count / generation_timeout_failures_total, 4)}"
            for run_id, count in sorted(generation_timeout_failures_by_run_id.items())
            if (count / generation_timeout_failures_total) > args.max_generation_timeout_failure_share_per_run_id
        ]
        if over_generation_timeout_share:
            budget_violations.append({
                "rule": "max_generation_timeout_failure_share_per_run_id",
                "threshold": args.max_generation_timeout_failure_share_per_run_id,
                "violations": over_generation_timeout_share,
            })
    if args.max_analysis_timeout_failure_share_per_run_id and analysis_timeout_failures_total > 0:
        over_analysis_timeout_share = [
            f"{run_id}:{round(count / analysis_timeout_failures_total, 4)}"
            for run_id, count in sorted(analysis_timeout_failures_by_run_id.items())
            if (count / analysis_timeout_failures_total) > args.max_analysis_timeout_failure_share_per_run_id
        ]
        if over_analysis_timeout_share:
            budget_violations.append({
                "rule": "max_analysis_timeout_failure_share_per_run_id",
                "threshold": args.max_analysis_timeout_failure_share_per_run_id,
                "violations": over_analysis_timeout_share,
            })
    ...
    manifest = {
        ...
        "max_planned_sample_temperature_top5_share": args.max_planned_sample_temperature_top5_share,
        "max_planned_sample_temperature_top6_share": args.max_planned_sample_temperature_top6_share,
        "max_planned_sample_temperature_top7_share": args.max_planned_sample_temperature_top7_share,
        "max_planned_sample_temperature_top8_share": args.max_planned_sample_temperature_top8_share,
        "max_planned_sample_temperature_top9_share": args.max_planned_sample_temperature_top9_share,
        "max_planned_sample_temperature_top10_share": args.max_planned_sample_temperature_top10_share,
        "max_planned_sample_temperature_top11_share": args.max_planned_sample_temperature_top11_share,
        "max_planned_sample_temperature_top12_share": args.max_planned_sample_temperature_top12_share,
        "max_planned_sample_temperature_top13_share": args.max_planned_sample_temperature_top13_share,
        "max_planned_sample_temperature_top14_share": args.max_planned_sample_temperature_top14_share,
        "max_planned_sample_temperature_top15_share": args.max_planned_sample_temperature_top15_share,
        "max_planned_sample_temperature_top16_share": args.max_planned_sample_temperature_top16_share,
        "max_planned_sample_temperature_top17_share": args.max_planned_sample_temperature_top17_share,
        "max_planned_sample_temperature_top18_share": args.max_planned_sample_temperature_top18_share,
        "max_planned_sample_temperature_top19_share": args.max_planned_sample_temperature_top19_share,
        "max_planned_sample_temperature_top20_share": args.max_planned_sample_temperature_top20_share,
        "max_planned_sample_temperature_top21_share": args.max_planned_sample_temperature_top21_share,
        "min_planned_sample_temperature_tail_share": args.min_planned_sample_temperature_tail_share,
        "min_planned_sample_temperature_min_share": args.min_planned_sample_temperature_min_share,
        "planned_sample_temperature_floor_share": args.planned_sample_temperature_floor_share,
        "min_planned_sample_temperature_floor_bins": args.min_planned_sample_temperature_floor_bins,
        "max_planned_sample_temperature_floor_bin_share_gap": args.max_planned_sample_temperature_floor_bin_share_gap,
        ...
        "max_planned_sample_temperature_top5_over_uniform_ratio": args.max_planned_sample_temperature_top5_over_uniform_ratio,
        "max_planned_sample_temperature_top6_over_uniform_ratio": args.max_planned_sample_temperature_top6_over_uniform_ratio,
        "max_planned_sample_temperature_top7_over_uniform_ratio": args.max_planned_sample_temperature_top7_over_uniform_ratio,
        "max_planned_sample_temperature_top8_over_uniform_ratio": args.max_planned_sample_temperature_top8_over_uniform_ratio,
        "max_planned_sample_temperature_top9_over_uniform_ratio": args.max_planned_sample_temperature_top9_over_uniform_ratio,
        "max_planned_sample_temperature_top10_over_uniform_ratio": args.max_planned_sample_temperature_top10_over_uniform_ratio,
        "max_planned_sample_temperature_top11_over_uniform_ratio": args.max_planned_sample_temperature_top11_over_uniform_ratio,
        "max_planned_sample_temperature_top12_over_uniform_ratio": args.max_planned_sample_temperature_top12_over_uniform_ratio,
        "max_planned_sample_temperature_top13_over_uniform_ratio": args.max_planned_sample_temperature_top13_over_uniform_ratio,
        "max_planned_sample_temperature_top14_over_uniform_ratio": args.max_planned_sample_temperature_top14_over_uniform_ratio,
        "max_planned_sample_temperature_top15_over_uniform_ratio": args.max_planned_sample_temperature_top15_over_uniform_ratio,
        "max_planned_sample_temperature_top16_over_uniform_ratio": args.max_planned_sample_temperature_top16_over_uniform_ratio,
        "max_planned_sample_temperature_top17_over_uniform_ratio": args.max_planned_sample_temperature_top17_over_uniform_ratio,
        "max_planned_sample_temperature_top18_over_uniform_ratio": args.max_planned_sample_temperature_top18_over_uniform_ratio,
        "max_planned_sample_temperature_top19_over_uniform_ratio": args.max_planned_sample_temperature_top19_over_uniform_ratio,
        "max_planned_sample_temperature_top20_over_uniform_ratio": args.max_planned_sample_temperature_top20_over_uniform_ratio,
        "max_planned_sample_temperature_top21_over_uniform_ratio": args.max_planned_sample_temperature_top21_over_uniform_ratio,
        ...
        "max_planned_sample_temperature_p99_over_p95_share_ratio": args.max_planned_sample_temperature_p99_over_p95_share_ratio,
        "max_planned_sample_temperature_p99_over_p90_share_ratio": args.max_planned_sample_temperature_p99_over_p90_share_ratio,
        "max_planned_sample_temperature_p99_over_p85_share_ratio": args.max_planned_sample_temperature_p99_over_p85_share_ratio,
        "max_planned_sample_temperature_p99_over_p80_share_ratio": args.max_planned_sample_temperature_p99_over_p80_share_ratio,
        "max_planned_sample_temperature_p99_over_p75_share_ratio": args.max_planned_sample_temperature_p99_over_p75_share_ratio,
        "max_planned_sample_temperature_p99_over_p70_share_ratio": args.max_planned_sample_temperature_p99_over_p70_share_ratio,
        "max_planned_sample_temperature_p99_over_p65_share_ratio": args.max_planned_sample_temperature_p99_over_p65_share_ratio,
        "max_planned_sample_temperature_p99_over_p60_share_ratio": args.max_planned_sample_temperature_p99_over_p60_share_ratio,
        "max_planned_sample_temperature_p99_over_p55_share_ratio": args.max_planned_sample_temperature_p99_over_p55_share_ratio,
        "max_planned_sample_temperature_p99_over_p50_share_ratio": args.max_planned_sample_temperature_p99_over_p50_share_ratio,
        "max_planned_sample_temperature_p99_over_p45_share_ratio": args.max_planned_sample_temperature_p99_over_p45_share_ratio,
        "max_planned_sample_temperature_p99_over_p40_share_ratio": args.max_planned_sample_temperature_p99_over_p40_share_ratio,
        "max_planned_sample_temperature_p99_over_p35_share_ratio": args.max_planned_sample_temperature_p99_over_p35_share_ratio,
        "max_planned_sample_temperature_p99_over_p30_share_ratio": args.max_planned_sample_temperature_p99_over_p30_share_ratio,
        "max_planned_sample_temperature_p99_over_p25_share_ratio": args.max_planned_sample_temperature_p99_over_p25_share_ratio,
        ...
        "max_generation_timeout_failure_share_per_run_id": args.max_generation_timeout_failure_share_per_run_id,
        ...
        "max_analysis_timeout_failure_share_per_run_id": args.max_analysis_timeout_failure_share_per_run_id,
