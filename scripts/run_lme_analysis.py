...
def load_and_score(data_dir: pathlib.Path) -> pd.DataFrame:
    ...
    rows = []
    for fname in ["batch_v1_pilot_openai", "batch_v1_gemini_v2", "batch_v3_expand", "batch_v4_expand_gpt4o", "batch_v5_expand_both", "batch_v6_expand", "batch_v7_expand", "batch_v8_neutral_balance", "batch_v9_gpt35"]:
