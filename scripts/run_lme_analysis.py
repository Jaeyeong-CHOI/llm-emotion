...
def load_and_score(data_dir: pathlib.Path) -> pd.DataFrame:
    ...
    rows = []
    for fname in ["batch_v1_pilot_openai", "batch_v1_gemini", "batch_v1_gemini_v2", "batch_v3_expand", "batch_v4_expand_gpt4o", "batch_v5_expand_both", "batch_v6_expand", "batch_v7_expand", "batch_v8_neutral_balance", "batch_v9_gpt35", "batch_gemini25flashlite", "batch_gpt54mini", "batch_gpt54nano", "batch_llama33_70b", "batch_llama4_scout", "batch_qwen3_32b", "batch_gpt41", "batch_gpt41mini", "batch_gpt4omini", "batch_gemini3flash", "batch_gemini25pro", "batch_gemini3pro", "batch_gemini31pro", "batch_v10_neutral_expand", "batch_v11_neutral_balance2", "batch_v12_gemini3pro_cf", "batch_v13_openai_balance", "batch_v14_balance", "batch_v15_new_models", "batch_v16_oss_small", "batch_v17_groq_compound", "batch_v18_new_groq", "batch_v19_groq_fill", "batch_v20_safeguard", "batch_v21_gemini_new", "batch_v22_cf_fill", "batch_v23_new_openai", "batch_v24_fill_cells", "batch_v25_groq_compound_balance", "batch_v26_lowcount_fill", "batch_v27_o3mini", "batch_v28_new_openai", "batch_v29_stability_fill", "batch_v30_stability_fill2", "batch_v31_gpt54full", "batch_v32_o1_o3", "batch_v33_o1_o3_neutral_fill", "batch_v34_gpt5_family", "batch_v35_gpt51_gpt52", "batch_v36_stability_fill", "batch_v36b_final_fill", "batch_v36c_gpt5_dep", "batch_v37_groq_balance", "batch_v38_explicit_instruction", "batch_v39_new_models", "batch_v40_gpt5pro_fill", "batch_v41_dep_balance", "batch_v42_cf_neutral_balance", "batch_v43_gpt5pro_stabilize", "batch_v44_nano_o3mini_stabilize", "batch_v45_stabilize_final", "batch_v46_gpt5pro_cf_fill", "batch_v47_stability_fill", "batch_v48_groq_stabilize", "batch_v49_groq_fill"]:
...
def run_lme(df: pd.DataFrame) -> dict:
    ...
    # Filter to core conditions only (exclude explicit_instruction baseline etc.)
    df2 = df[df["condition"].isin(["neutral", "deprivation", "counterfactual"])].copy()
