...
def print_markdown_rows(rows: list[tuple[str, Any]], indent: str = "") -> None:
    """Render and print compact markdown bullet rows."""

    print("\n".join(render_markdown_rows(rows, indent=indent)))
...
def main() -> None:
    ...
    if last_error:
        print_markdown_rows([("last_error", last_error)])
