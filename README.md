...
- Prompt bank expanded to `v4.2` with temporal-holdout / antithetic-pair / stage-budget starvation scenarios (`screening_temporal_holdout_blindspot`, `prompt_bank_antithetic_pair_gap`, `runner_stage_budget_starvation`) and personas (`screening_recall_triager`, `prompt_antithesis_designer`, `stage_budget_orchestrator`). Experiment matrix now includes `screening_prompt_runner_governance_v43`.
